...
class ClientMainWindow(QMainWindow):
    def __init__(self, database, transport, keys):
        ...
        self.ui.menu_3s.triggered.connect(self.actionBold)
        self.ui.menu_4s.triggered.connect(self.actionItalic)
        self.ui.menu_5s.triggered.connect(self.actionUnderlined)
    ...
    def add_contact_action(self, item):
        new_contact = item.selector.text()
